...
class BookDetailsPage extends StatefulWidget {
  final BookDataApi bookDataApi;
  final SelectedBookCategoryApi categoryBook;
  BookDetailsPage({Key key, this.bookDataApi, this.categoryBook})
      : super(key: key);
...
class _BookDetailsPageState extends State<BookDetailsPage> {
  ...
  void _handlePaymentSuccess(PaymentSuccessResponse response) {
    purchaseBooksAPI(
        context, userID, widget.categoryBook.bookId, response.paymentId);
  }
  ...
  _loadInitial() async {
    ...
    setState(() {
      ...
      passWord = _passWord;
      this.checkBookStatus(context, userID, widget.categoryBook.bookId);
    });
  }
                  ...
                  Padding(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                          imageUrl: widget.categoryBook.bookImage,
                      ...
                      children: [
                        Row(
                          children: [
                            Expanded(
                              child: Text(
                                widget.categoryBook.bookName.toUpperCase(),
                                style: TextStyle(
                                  fontFamily: 'OpenSans',
                        ...
                        Text(
                          widget.categoryBook.authorName,
                          style: TextStyle(
                            fontFamily: 'OpenSans',
                            fontWeight: FontWeight.w400,
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    color: Colors.black),
                                child: Text(
                                  widget.categoryBook.categoryName
                                      .toUpperCase(),
                                  style: TextStyle(
                                    fontFamily: 'OpenSans',
                                    fontWeight: FontWeight.w400,
                        ...
                        Row(
                          ...
                          children: [
                                  ...
                                  if (isPurchased == true) {
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(builder: (context) {
                                        return PDFPage(
                                          title: widget.categoryBook.bookName,
                                          path: widget.categoryBook.bookPath,
                                        );
                                      }),
                                    );
                                  } else {
                                    openCheckout(
                                        int.parse(widget.categoryBook.amount) *
                                            100,
                                        widget.categoryBook.bookName,
                                        userMobile);
                                  }
                                },
                            ...
                            Padding(
                              ...
                              child: Text(
                                '₹ ' +
                                    double.parse(widget.categoryBook.amount)
                                        .toStringAsFixed(2),
                                style: TextStyle(
                                  fontFamily: 'OpenSans',
                                  fontSize: 16,
