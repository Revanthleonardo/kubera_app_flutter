...
class AuthorBookDetailsPage extends StatefulWidget {
  final SelectedBookAuthorApi bookDataApi;
  AuthorBookDetailsPage({
    Key key,
    this.bookDataApi,
  }) : super(key: key);

  @override
  State<AuthorBookDetailsPage> createState() => _AuthorBookDetailsPageState();
}

class _AuthorBookDetailsPageState extends State<AuthorBookDetailsPage> {
